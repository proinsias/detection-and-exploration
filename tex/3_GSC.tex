...
\section{TrES Telescope Observations of \\ \mbox{GSC 03885-00829}}
\label{cha:gsc:sec:tres}
...
\section{Spectroscopic Follow-up of \mbox{GSC 03885-00829}}
\label{cha:gsc:sec:spec}
...
Mg~\textsc{\small I}~$b$ triplet) and the corresponding cross-correlation function.}
\label{cha:gsc:fig:spectrum}
\end{center}
\end{figure}
...
\caption[$g$-band observations modeled as an F/K+M blend]{Binned $g$-band observations of \mbox{GSC 03885-00829}
  ...
  well fit, the predicted duration is slightly shorter than observed.}
\label{cha:gsc:fig:KMmodel}
\end{center}
\end{figure}
...
\section{Confirmation of Blend Model}
\label{cha:gsc:sec:nirspec}
...
\caption[Spectrum showing evidence of light from late-type star]{$K$-band spectra of \mbox{GSC 03885-00829} and a nearby
  ...
  possibility of a planetary companion.}
\label{cha:gsc:fig:nirspec}
\end{center}
\end{figure}
