...
(\citealp[e.g.,][]{ODonovan_Charbonneau_Alonso:apj:2007a}, see chapter~\ref{cha:and0}).% chktex 9 chktex 10
...
(\citealp[][]{Torres_Konacki_Sasselov:apj:2004b,% chktex 9
  Mandushev_Torres_Latham:apj:2005a}; \citealp{ODonovan_Charbonneau_Torres:apj:2006a}, see chapter~\ref{cha:gsc}).% chktex 10
...
$B-V$ \phm{$0000000.$} (mag) &  \phn$0.619\pm0.009$ & 1 \\% chktex 40
$U-B$  \phm{$0000000.$} (mag) &  \phn$0.112\pm0.012$ & 1\\% chktex 40
$V-R_{\mathrm C}$  \phm{$000000.$} (mag) &  \phn$0.361\pm0.008$ & 1\\% chktex 40
...
$M_{p}\, \sin{i} = 1.206 \pm 0.016\, (\frac{M_p + M_{\star}}{M_{\sun}})^{2/3}\ M_{\mathrm Jup}$,% chktex 3
where $i$ is
