...
This may suggest different evolution of these planetary systems than the canonical migration (\citealp[see, e.g.,][]{Trilling_Benz_Guillot:apj:1998a}) of hot Jupiters from beyond the ice line.% chktex 9 chktex 10
...
\section{Observations and Analysis of \tresThree}\label{cha:tres3:sec:observations}
...
\startdata\
R.A. \phm{0000000...} (J2000.0)  &  \phm{0}$17^{\mathrm h} 52^{\mathrm m} 07.03^{\mathrm s}$ &  \\% chktex 11
...
$T_{\mathrm eff}$ \phm{000000000..} (K) & $5720 \pm 150$ & 1 \\
$\log{g}$ \phm{00000000..} (dex) & \phm{0}$4.6 \pm 0.3$ & 1 \\
$v\sin{i}$ \phm{0000000..} (${\mathrm km\, s^{-1}}$) & $< 2$ & 1 \\
$V$ \phm{00000000000.} (mag) & $12.402\pm0.006$ & 1 \\
$B-V$ \phm{0000000.} (mag) &  \phn$0.712\pm0.009$ & 1 \\
$V-R_{\mathrm C}$  \phm{$000000.$} (mag) &  \phn$0.417\pm0.010$ & 1\\% chktex 40
$V-I_{\mathrm C}$  \phm{$0000000$} (mag) &  \phn$0.799\pm0.010$ & 1\\
...
We have described the software used to derive relative radial velocities with an iodine cell in earlier works (\citealp[e.g.,][]{ODonovan_Charbonneau_Mandushev:apjl:2006a}, see chapter~\ref{cha:tres2}; \citealp{Sozzetti_Torres_Latham:apj:2006a}).% chktex 9 chktex 10
...
$M_{p}$  \phm{00.} ($M_{\mathrm Jup}$) &  \phm{000000} $1.92 \pm 0.23$ \\
$R_{p}/R_{\star}$ &  \phm{000000} $0.1660 \pm 0.0024$ \\
$R_{p}$ \tablenotemark{a}  \phm{00..} ($R_{\mathrm Jup}$) \tablenotemark{b} &  \phm{000000} $1.295 \pm 0.081$ \\
\enddata\
\tablenotetext{a}{%
...
\tablenotetext{b}{%
Here, $R_{\mathrm Jup} = 71,\!492$~km, the equatorial radius of Jupiter at 1~bar.%
}
\end{deluxetable}% chktex 9
...
We find a minimum planetary mass of \mbox{$M_p \sin i = 2.035 \pm 0.090 [(M_p+M_{\star})/M_{\sun}]^{2/3} M_{\mathrm Jup}$}, where $i$ represents the orbital inclination.% chktex 3
...
\section[Estimates of Planet Parameters and Conclusions]{Estimates of Planet Parameters and \\ Conclusions}\label{cha:tres3:sec:discuss}
...
Assuming isotropic emission, the equilibrium temperature of \tresThree\ is $1643(1-A)^{1/4}$\,K, where $A$ is the Bond albedo.% chktex 3
...
The flux of the planet near opposition relative to that of the star is $p_{\lambda} \times (R_p / a)^2 = p_{\lambda} \times 7.5 \times 10^{-4}$, which is more than twice that of any of the other known nearby transiting planets.% chktex 3 chktex 17
